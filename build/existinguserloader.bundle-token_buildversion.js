...
var ExistingUserLoader = function (_Component) {
  _inherits(ExistingUserLoader, _Component);

  function ExistingUserLoader(props, context) {
    _classCallCheck(this, ExistingUserLoader);

    var _this = _possibleConstructorReturn(this, (ExistingUserLoader.__proto__ || Object.getPrototypeOf(ExistingUserLoader)).call(this, props, context));

    _this.congratulationsModalClose = function () {
      _this.setState({ isOpenExistingUserLoader: false });
      _this.props.postCongratulationsCloseAction();
    };
  ...
  _createClass(ExistingUserLoader, [{
    key: 'componentWillMount',
    value: function componentWillMount() {
      var _RDL$TrackEvents;

      RDL.TrackEvents(typeCd.eventTypes.builderUsage, (_RDL$TrackEvents = {}, _defineProperty(_RDL$TrackEvents, typeCd.eventPropsKeys.builderType, typeCd.eventPropsValues.coverLetters), _defineProperty(_RDL$TrackEvents, typeCd.eventPropsKeys.action, typeCd.eventPropsValues.actions.viewed), _defineProperty(_RDL$TrackEvents, typeCd.eventPropsKeys.screenName, typeCd.eventPropsValues.existingAccount), _defineProperty(_RDL$TrackEvents, typeCd.eventPropsKeys.flowName, typeCd.eventPropsValues.coverLetterV2React), _RDL$TrackEvents), this.props.UserUID, 'TRUE');
      this.setState({ isOpenExistingUserLoader: this.props.isOpenExistingUserLoader });
    }
  }, {
    key: 'componentWillReceiveProps',
    value: function componentWillReceiveProps(nextProps) {
      this.setState({ isOpenExistingUserLoader: nextProps.isOpenExistingUserLoader });
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement('section', null, _react2.default.createElement(_popup2.default, {
        isOpen: true,
        title: window.RDL.Localization.lbl_existingUser,
        hasFooter: false,
        ...
        cssClass: {
          modalDialog: "modal-confirm exist-account-modal",
          modalHeader: "",
          btnPrimary: "btn-primary col",
          modalFooter: "modal-footer-flat bg-white justify-content-center pb-5 border-0",
          overlayClassName: " modal-vertical-center modal-overlay onboarding-overlay"
        },
        popupDescription: typeCd.PopupDescriptionAriaAttr.ExistingUserLoader
      }, _react2.default.createElement('div', { className: 'modal-body' }, _react2.default.createElement('div', { className: 'row' }, _react2.default.createElement('div', { className: 'col-md-12' }, _react2.default.createElement('h4', { className: 'mb-2 mt-4' }, window.RDL.Localization.lbl_existingUserHeading), _react2.default.createElement('div', { className: 'clearfix' }, _react2.default.createElement('div', { className: 'spinner-circle float-left' }, _react2.default.createElement('div', { className: 'spinner-circle-gradient' }), _react2.default.createElement('div', { className: 'spinner-circle-inner' })), _react2.default.createElement('p', { className: 'paragraph' }, window.RDL.Localization.lbl_existingUserPara)))))));
    }
  }]);

  return ExistingUserLoader;
}(_react.Component);

exports.default = ExistingUserLoader;
...
var _safeHTMLElement = __webpack_require__(196);
...
var _ModalPortal = __webpack_require__(345);

var _ModalPortal2 = _interopRequireDefault(_ModalPortal);

var _ariaAppHider = __webpack_require__(251);
...
var _reactLifecyclesCompat = __webpack_require__(220);
...
var _focusManager = __webpack_require__(346);

var focusManager = _interopRequireWildcard(_focusManager);

var _scopeTab = __webpack_require__(347);
...
var _classList = __webpack_require__(349);
...
var _portalOpenInstances = __webpack_require__(252);
...
var _tabbable = __webpack_require__(250);
